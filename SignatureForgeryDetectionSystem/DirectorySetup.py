...
## -----------------------------------------------------------------------------------------------------------
## Directory Setup
main_path = "./SignatureForgeryDetectionSystem/MachineLearning/Preprocessing/"

os.makedirs(os.path.join(main_path, "Dataset"), exist_ok=True)


datasetDir_path = "./SignatureForgeryDetectionSystem/MachineLearning/Preprocessing/Dataset/"
...
processingDir_path = "./SignatureForgeryDetectionSystem/MachineLearning/Preprocessing/Dataset/Processing/"
...
resourcesDir_path = "./SignatureForgeryDetectionSystem/MachineLearning/Preprocessing/Dataset/Resources/"
